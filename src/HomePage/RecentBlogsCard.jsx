...
const email = user?.email
    ...
    return (
        ...
        <div className="lg:w-8/12">
             <img className="rounded-xl  lg:h-[275px] object-cover" src={photo} alt="" />
         </div>
         <div className="lg:w-9/12 flex flex-col items-start">
             <h1 className="md:text-4xl lg:text-start text-2xl font-bold mb-4"> {title}</h1>
             <p className="text-gray-500 lg:text-start "> {short_description}</p>
             <p className="text-gray-500 font-bold mt-2 lg:text-start"><span className="font-bold text-black">Category: </span>{category}</p>
